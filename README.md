...
<table>
  <tr>
    <td> <img src="https://avatars2.githubusercontent.com/u/34519842?s=400&u=1d29afaac44f477cbb0226139ec83f73faefe154&v=4"  alt="Ampere Computing" width = 360px height = 640px ></td>

    <td><img src="https://almalinux.org/static/images/logo.svg" alt="AlmaLinux" width = 360px height = 640px></td>
   </tr> 
  </tr>
</table>
...
The goal of this code is to supply the minimal ammount of information to quickly have working [AlmaLinux](https://almalinux.org/) Ampere A1 instance on OCI ["Always Free"](https://www.oracle.com/cloud/free/#always-free).  This instance is confured with metadata to install required software, configure itself, and build Ansible AWX.
